...
public abstract class GenericDAOImpl<T,K> implements GenericDAO<T, K> {
	...
	public List<T> listar(){
		...
		//Configurar o máximo de resultados na pesquisa
	...
	public List<T> listar(int posicao, int maximo){
		return em.createQuery("from " + clazz.getName(), clazz)
				.setFirstResult(posicao) //posição do primeiro registro que será retornado
				.setMaxResults(maximo) //máximo de resultados
				.getResultList();
	}
